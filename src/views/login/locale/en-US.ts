export default {
  ...
  'register.form.subTitle': 'Enter your message to create your personal account',
  'register.form.confirm': 'Sign Up',
  'register.form.cancel': 'Already have a account? Sign in',
  'register.form.success': 'register succeed',
